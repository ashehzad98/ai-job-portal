...
type JobFeedControlsProps = {
    ...
    activeDetailedFilterCount: number;
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button
                        ...
                        aria-controls="detailed-job-filters"
                        onClick={onToggleDetailedFilters}
                        className={[
                            "inline-flex min-h-11 items-center justify-center gap-2 rounded-lg border px-3 py-2.5 text-sm font-semibold transition",
